...
| Capture test shot | Noise-floor fail / drift / unsettled dialog (**Why?** neutral button; does not dismiss) | `capture_noise_*_title` / `_body` | `url_faq_noise_floor` | `#noise-floor` |
| Capture test shot | Speckle-fail dialog (**Why?**; does not dismiss) | `capture_speckle_fail_*` | `url_faq_speckle` | `#speckle-contrast` |
