...
images, added 2026-09-26), and each package's five newest versions. Only those are rollback
...
revision that cannot start an instance. Tag an image `rollback-…` to keep it. Artifact Registry records
