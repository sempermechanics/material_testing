...
| TD-49 | Docs | `CONTEXT.md` was 83 % changelog (lines 134–780) | 3 | 2 | 2 | **20** | **Fixed** (docs-truth PR #155, trimmed again 2026-09-24): history lives in [CHANGELOG.md](CHANGELOG.md). `CONTEXT.md` is 160 lines, not the planned ≤ 140; what remains is the glossary, layout, invariants and traps, which exist nowhere else |
