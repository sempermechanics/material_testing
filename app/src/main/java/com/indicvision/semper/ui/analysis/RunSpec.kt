 ...
 * @property mechanical the test type, dimensions and loads the wizard held;
 *   a sweep's carries no loads
 */
...
data class RunSpec(
    ...
    val mechanical: MechanicalTestInputs = MechanicalTestInputs.NONE,
) {
