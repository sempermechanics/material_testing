 ...
 * 595 × 842 pt. The report layouts draw in a 2480 × 3508 design space (A4 at
 * 300 dpi) so their text sizes and rules read as pixels; each page's canvas is
 * scaled onto the real page. Declaring the design size as the page size, as the
 * layouts once did, made an 87.5 × 123.8 cm page that printed at a quarter scale.
 */
